...
ActiveRecord::Schema[7.0].define(version: 2021_11_24_050519) do
  ...
  create_table "osu_auth_requests", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
